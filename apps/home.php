...
<body>
			...
			<div class="carousel-item active">
				...
				<div class="carousel-caption d-none d-md-block">
					<div style="margin-top: 10px;margin-bottom: 10px;">
						...
						<button type="submit" class="btn btn-danger btn-lg" onclick="location.href = 'signup.php';">DAFTAR SEKARANG</button>
					</div>
				</div>
			</div>
	...
	<div id="kontak">
		<h3 style="margin-top:80px;padding-top: 50px" class="display-4"><b>KONTAK KAMI</b></h3>
		<div class="row">
			<div class="col">
			</div>
