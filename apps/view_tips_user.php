...
<html>
<head>
    <title>Halaman View Tips User</title>
...
<body>
    <nav class="navbar navbar-expand-lg" style="background-color:#C70039">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="view_tips_user" style="color: white">Tips Diet</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container" id="home">
        <div class="row">
            ...
            <div class="col-12">
                <h3 class="text-center display-4">Tips untuk Diet</h3>
                <?php
                $conn = mysqli_connect("localhost", "root", "", "PPL");

                $query = "SELECT * FROM data_tips";
